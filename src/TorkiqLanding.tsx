...
const CTAButton = ({ children, ...props }) => (
  <a
    href="#get-started"
    className="inline-flex items-center gap-2 rounded-2xl px-5 py-3 font-semibold shadow-md transition hover:shadow-lg bg-violet-700 text-white hover:bg-violet-800 dark:bg-violet-600 dark:text-white"
    {...props}
  >
...
export default function TorkiqLanding() {
  ...
  useEffect(() => {
    try {
      ...
      const demoEl = document.querySelector('[data-testid="cta-demo"]') as HTMLElement | null;
      if (demoEl && typeof (demoEl as any).className === 'string') {
        console.assert((demoEl as any).className.includes('bg-violet-700'), "Primary CTA should use violet theme");
      }

      const teamFooter = document.getElementById('team-footer');
      console.assert(!!teamFooter, "Footer should include team section");
    } catch (e) {
      // keep UI resilient
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-violet-50 via-white to-indigo-50 text-slate-900 dark:from-slate-950 dark:via-slate-950 dark:to-slate-900">
      {/* Nav */}
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-6 pb-16 pt-14 md:grid-cols-2 md:pt-24">
          <div>
            ...
            <p className="mt-5 max-w-xl text-lg text-slate-600 dark:text-slate-300">
              Supercharge your business with autonomous agents that automate bookkeeping, reconciliations, reporting and compliance—so you can focus on customers and growth.
            </p>
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <CTAButton>Get early access</CTAButton>
              <a href="#demo" className="inline-flex items-center gap-2 rounded-2xl border px-5 py-3 font-semibold text-violet-700 border-violet-200 hover:bg-violet-50 dark:text-violet-300 dark:border-violet-800 dark:hover:bg-slate-900">
                Watch demo
              </a>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-3 text-slate-600 dark:text-slate-300">
              Even with cloud accounting, owners lose hours on reconciliations, coding receipts, compliance checks, and month end packs. TorkIQ automates the busywork so you can focus on customers and growth.
            </p>
          </div>
          ...
          <div className="grid items-start gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mt-3 max-w-xl text-slate-600 dark:text-slate-300">
                Deploy purpose built agents trained for accounting workflows. Start with our ready made agents or request bespoke agents tailored to your business.
              </p>
          ...
          <div className="grid items-center gap-8 md:grid-cols-3">
            ...
            <div className="rounded-3xl border p-6 text-sm dark:border-slate-800">
              ...
              <blockquote className="mt-3 border-l-2 pl-4 text-slate-600 dark:text-slate-300">
                “With TorkIQ, we cut reconciliation time by 70% and redirected staff to sales and service. Setup took under an hour.”
              </blockquote>
        ...
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <form className="mx-auto mt-6 flex max-w-xl flex-col items-center gap-3 sm:flex-row">
            <div className="relative w-full">
              ...
              <input type="email" required placeholder="you@business.com" className="w-full rounded-2xl border px-10 py-3 outline-none ring-violet-500/30 focus:ring-4 dark:border-slate-800 dark:bg-slate-900" />
            </div>
            <button type="submit" data-testid="btn-waitlist" className="w-full rounded-2xl bg-violet-700 px-5 py-3 font-semibold text-white shadow-md transition hover:shadow-lg dark:bg-violet-600 dark:text-white sm:w-auto">Join waitlist</button>
          </form>
      ...
      <footer id="about" className="border-t bg-white py-12 text-sm dark:border-slate-800 dark:bg-slate-950">
        <div className="mx-auto grid max-w-7xl gap-8 px-6 md:grid-cols-3">
          <div>
            ...
            <p className="mt-2 max-w-sm text-slate-600 dark:text-slate-300">The AI agent factory for business owners. Built for Xero. QuickBooks coming soon.</p>
          </div>
          <div>
